...
import com.ar.bakingapp.ExoPlayerManager;
...
public class PlayerFragment extends Fragment implements ExoPlayer.EventListener {
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        if (mExoPlayer != null) {
            ...
            Log.i("PlayerFrag", "saving playback position: " + mExoPlayer.getCurrentPosition());
        }
...
//            Log.i("PlayerFrag", "restoring playback position: " + mExoPlayer.getCurrentPosition());
        ...
        /********************/
        previewTimeBar = rootView.findViewById(R.id.exo_progress);
        imageViewPreview = rootView.findViewById(R.id.imageView);
        /*********************/
    ...
    public void onResume() {
        ...
        if (mExoPlayer != null && !mExoPlayer.getPlayWhenReady()) {
            Log.i("PlayerFrag", "setting playWhenReady to true...");
    ...
    private void initializePlayer(Uri mediaUri) {
        ...
        /*****************/
        ExoPlayerManager exoPlayerManager = new ExoPlayerManager(imageViewPreview);
    ...
    private void setupVideo(Uri mediaUri) {
        ...
        if (selectedObj.getId() == selectedStepId) {
            ...
            Log.i("PlayerFrag", "seeking to playback position: " + mExoPlayer.getCurrentPosition());
